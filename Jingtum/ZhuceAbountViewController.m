//
//  ZhuceAbountViewController.m
//  Jingtum
//
//  Created by sunbinbin on 15-1-8.
//  Copyright (c) 2014年 jingtum. All rights reserved.
//

#import "ZhuceAbountViewController.h"
#import "AppDelegate.h"

@interface ZhuceAbountViewController ()
{
    UIView *_navView;
...
@implementation ZhuceAbountViewController
...
- (void)viewDidLoad {
    ...
    [backButton setTitle:@"注 册" forState:UIControlStateNormal];
    ...
    NSString *filePath = [[NSBundle mainBundle] pathForResource:@"abountjingtum" ofType:@"html"];
