...
@interface ShopUseSureViewController ()
{
    UIView *_navView;
}
@end

@implementation ShopUseSureViewController
...
- (void)viewDidLoad {
    ...
    self.textView.text=self.tmpUsersure;
