...
#define CANCEL_BUTTON_COLOR                     [UIColor colorWithRed:114/255.00f green:121/255.00f blue:132/255.00f alpha:1]
...
#define ACTIONSHEET_BACKGROUNDCOLOR             [UIColor colorWithRed:232/255.00f green:232/255.00f blue:232/255.00f alpha:0.8]
...
{
    UILabel *titlelabel = [[UILabel alloc] initWithFrame:CGRectMake1(TITLE_INTERVAL_WIDTH, TITLE_INTERVAL_HEIGHT, TITLE_WIDTH, TITLE_HEIGHT)];
...
{
    UIButton *destructiveButton = [UIButton buttonWithType:UIButtonTypeRoundedRect];
    destructiveButton.frame=CGRectMake1(BUTTON_INTERVAL_WIDTH, BUTTON_INTERVAL_HEIGHT, BUTTON_WIDTH, BUTTON_HEIGHT);
...
- (UIButton *)creatOtherButtonWith:(NSString *)otherButtonTitle withPostion:(NSInteger )postionIndex
{
    ...
    otherButton.frame=CGRectMake1(BUTTON_INTERVAL_WIDTH, BUTTON_INTERVAL_HEIGHT + (postionIndex*(BUTTON_HEIGHT+(BUTTON_INTERVAL_HEIGHT/2))), BUTTON_WIDTH, BUTTON_HEIGHT);
#ifdef IOS7_SDK_AVAILABLE
...
- (UIButton *)creatCancelButtonWith:(NSString *)cancelButtonTitle
{
    ...
    cancelButton.frame=CGRectMake1(BUTTON_INTERVAL_WIDTH, BUTTON_INTERVAL_HEIGHT, BUTTON_WIDTH, BUTTON_HEIGHT);
