...
- (void)verify{
    ...
    [gesturePasswordView.state setText:@"确认手势密码"];
...
- (void)reset{
    gesturePasswordView = [[GesturePasswordView alloc]initWithFrame:[UIScreen mainScreen].bounds];
    [gesturePasswordView.state setTextColor:[UIColor colorWithRed:2/255.f green:174/255.f blue:240/255.f alpha:1]];
    [gesturePasswordView.state setText:@"设置手势密码"];
...
- (void)back
{
    ...
    [[NSNotificationCenter defaultCenter] postNotificationName:kNotificationUserSecret object:nil];
}
